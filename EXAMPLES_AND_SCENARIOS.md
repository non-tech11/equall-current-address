...
### 1.4 Village, ward instead of a street name

*Rural Andhra — short but complete, no landmark needed*
...
| B6 | Neither street nor landmark | houseNo `9-208-1`, area `Bahadurpet` | 2 | **locality:** Enter street / gali / colony<br>**form:** Your address needs more detail — add street, area or a landmark |
| B7 | Landmark given, street left empty | houseNo `9-208-1`, area `Bahadurpet`, landmark `Near the bus stop` | 3 | **locality:** Enter street / gali / colony |
